    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Criando uma pesquisa</h3>
            </div>
            <form role="form" method="post" action="/searchEvents/add">
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Titulo da pesquisa</label>
                        <input type="text" required name="data[SearchEvent][title]" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="data[SearchEvent][school]" class="form-control"
